<?php
// WP_DB_NAME=wp_scratch WP_HOME=http://localhost/ WP_ABSPATH=/usr/share/wordpress WP_DB_USER=wp_scratch WP_DB_PASS=wp_scratch WP_DB_HOST=localhost php ./rename_site.php
// WP_DB_NAME=wp_scratch WP_HOME=http://localhost/ WP_ABSPATH=/usr/share/wordpress WP_DB_USER=wp_scratch WP_DB_PASS=wp_scratch WP_DB_HOST=localhost ./wp --path=/usr/share/wp_cr_loc/ search-replace http://xxx.de/ http://yyy:81/
/*
